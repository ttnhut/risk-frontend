...
export class RiskService {
  ...
  public assignRisk(riskId:string | null) {
    return this.http.put(`${baseURL}${API['risks']}${riskId}/`, new Risk('','','','',new MasterData('','',''),new MasterData('','',''),new MasterData('','',''),new MasterData('','',''),new User(this.userService.getUser().email,'','',''),new User('','','',''),new Date(),null))
  }

  public updateProgressRisk(riskId:string | null, progressId: string) {
    return this.http.put(`${baseURL}${API['risks']}${riskId}/`, new Risk('','','','',new MasterData('','',''),new MasterData(progressId,'',''),new MasterData('','',''),new MasterData('','',''),new User('','','',''),new User('','','',''),new Date(),null))
  }
